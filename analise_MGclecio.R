...
dados=read.csv("D://bkp//Documents//Artigo//Programas//An·lise de dados reais//Dados_MG//AtlasBrasil_Consulta.csv")
fix(dados)
attach(dados)

par(mfrow=c(1,2))

summary(Esperan√.a.de.vida.ao.nascer.2010)
sd(Esperan√.a.de.vida.ao.nascer.2010)
skewness(Esperan√.a.de.vida.ao.nascer.2010)
kurtosis(Esperan√.a.de.vida.ao.nascer.2010)
hist(Esperan√.a.de.vida.ao.nascer.2010,breaks=50)
boxplot(Esperan√.a.de.vida.ao.nascer.2010,main='EsperanÁa de vida')
shapiro.test(Esperan√.a.de.vida.ao.nascer.2010)

esperanca_vida=Esperan√.a.de.vida.ao.nascer.2010
...
razao_dependencia=Raz√.o.de.depend√™ncia.2010
...
par(new=T)
plot(y,xlab='Y1',ylab='Y2',xlim=c(min(z),max(z)),ylim=c(min(w),max(w)),main='Slash normal assimÈtrica',pch=19)
